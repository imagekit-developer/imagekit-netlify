export const ERROR_IMAGEKIT_URL_ENDPOINT_REQUIRED = 'Imagekit url endpoint is required. Please provide imagekitUrlEndpoint input or use the environment variable IMAGEKIT_URL_ENDPOINT';
